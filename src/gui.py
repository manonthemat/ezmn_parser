...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        ttk.Button(mainframe, text='Collect Emails', command=self.collect).grid(column=0, row=6)
        
        ttk.Label(mainframe, text='Collected Email addresses below...', padding='0 20 0 0').grid(column=0, row=7)
        
        
        self.emailbox = Text(mainframe)
        self.emailbox.grid(column=0, row=8)
    ...
    def collect(self):
        ...
        self.emailbox.insert(END, '=======================\n'+str(i+1)+' unique Emails collected...')
